          ...
          <Row justify={"center"} gutter={16} style={{ padding: "50px 0" }}>
            ...
            <Col xs={24} sm={24} md={14} xl={14} xxl={14}>
              ...
              <Typography.Paragraph className={styles["white-text"]}>
                ...
                headquarters of InterGreat is located at 29 Threadneedle Street,
                London.
              ...
              <Typography.Paragraph className={styles["white-text"]}>
                IOT is currently the most accessed IELTS preparation website in
                over 120 countries with more than 28 million learners. We are a
                community-driven website offering free exam materials and IELTS
                preparation tips. With advanced technology features, learners
                can easily take online IELTS tests and quickly and effectively
                improve their scores. Additionally, we offer an educational
                ecosystem that revolves around online education, study abroad
                counseling, and student support to help students achieve their
                study abroad goals.
              </Typography.Paragraph>
            </Col>
          </Row>
